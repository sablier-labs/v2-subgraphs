import type {
  ...
  MerkleLockupFactoryV22Contract_CreateMerkleLockupLLEvent_eventArgs as EventCreateLinearArgs_V22,
  MerkleLockupFactoryV22Contract_CreateMerkleLockupLLEvent_loaderContext as LoaderCreateLinearContext_V22,
  MerkleLockupFactoryV22Contract_CreateMerkleLockupLLEvent_handlerContextAsync as HandlerCreateLinearContext_V22,
  /** Event: Create Tranched (Factory) */
  MerkleLockupFactoryV22Contract_CreateMerkleLockupLTEvent_eventArgs as EventCreateTranchedArgs_V22,
  MerkleLockupFactoryV22Contract_CreateMerkleLockupLTEvent_loaderContext as LoaderCreateTranchedContext_V22,
  MerkleLockupFactoryV22Contract_CreateMerkleLockupLTEvent_handlerContextAsync as HandlerCreateTranchedContext_V22,
  /** Event: Claim (Merkle) */
